...
if __name__ == '__main__':
    ...
    model = YOLO('../ObjectDetectionModel/model/train9/weights/best.pt')  # select your model.pt path
    ...
    for video_path in os.listdir(video_base_path):
        ...
        tracker = DeepOCSORT(
            model_weights=Path(
                'osnet_x1_0_msmt17_256x128_amsgrad_ep150_stp60_lr0.0015_b64_fb10_softmax_labelsmooth_flip.pt'),
